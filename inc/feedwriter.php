...
class FeedWriter
{
    ...
    private function beginFeed()
    {
        ...
        $this->feed->addChild('id', $this->_baseURL . $this->_feedID);
        $this->addWithAttribs($this->feed, 'title', $this->_feedID, ['type' => 'text']);
    ...
    private function addEntry($row)
    {
        ...
        $this->addWithAttribs(
            ...
            [
                ...
                'src' => $this->_baseURL . 'download/' . $row['PackageId'] . '/' . $row['Version'],
            ]
        );
    ...
    private function addEntryMeta($entry, $row)
    {
        ...
        $meta = [
            ...
            'GalleryDetailsUrl' => $this->_baseURL . 'details/' . $row['PackageId'] . '/' . $row['Version'],
