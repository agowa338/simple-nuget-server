...
class DB
{
    ...
    private static $_isMysql;

    public static function init()
    {
        static::$_conn = new PDO(
            Config::$dbName,
            Config::$dbUsername,
            Config::$dbPassword
        );
        static::$_conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        static::$_isMysql = static::$_conn->getAttribute(PDO::ATTR_DRIVER_NAME) == 'mysql';
        static::createTables();
    }
    ...
    private static function createTables()
    {
        static::$_conn->exec(
			...
			CREATE TABLE IF NOT EXISTS packages (
				...
				LatestVersion TEXT' . (static::$_isMysql ? ',
			...
			CREATE TABLE IF NOT EXISTS versions (
				...
				Copyright TEXT,
				IsPrerelease BOOLEAN' . (static::$_isMysql ? ',
    ...
    public static function insertOrUpdatePackage($params)
    {
        ...
        $stmt = static::$_conn->prepare(
            'INSERT ' . (static::$_isMysql ? '' : 'OR') . ' IGNORE INTO packages
